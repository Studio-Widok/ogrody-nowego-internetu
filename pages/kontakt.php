...
<div id="kontakt">
  <?php get_part('nav', ['current' => 'kontakt']); ?>
  <div class="rsep"></div>
  <div class="rsep"></div>
  <div class="content column">
    ...
    <div class="text">
      <p>
        ...
        <a href="https://www.grupa.robocza.org" class="fancy-link"
          target="_blank" rel="noopener noreferrer">grupa.robocza.org</a><br>
    ...
    <div class="rsep"></div>
    <div class="title accent">grupa robocza</div>
    <div class="r"></div>
    <div class="text">
      <p>
        ...
        Agnieszka Zgud<br>
        <a
          href="mailto:agnieszka.zgud@robocza.org">agnieszka.zgud@robocza.org</a>
      </p>

      <p>
        Kuba Kulesza<br>
        <a href="mailto:kuba.kulesza@robocza.org">kuba.kulesza@robocza.org</a>
      </p>
      ...
      <p>
        <b>Design Support</b><br>
        Katarzyna Janota
      </p>

      <p>
        Web Development<br>
        Cezary Stępkowski<br>
        Bartek (Studio Widok)
      </p>

      <p>
        Social Media<br>
        Piotr Dziadowicz (GRUPA ROBOCZA)
      </p>
    </div>
